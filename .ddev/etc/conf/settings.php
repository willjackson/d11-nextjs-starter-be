 ...
 *
 * The database connection, host patterns and permissions hardening are provided
 * by DDEV in settings.ddev.php, so only the project-specific local settings live
 * here.
 */
